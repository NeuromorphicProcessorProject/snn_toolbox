...
def inception_a(input_layer, nfilt):
    ...
    """
    l1 = bn_conv(input_layer, num_filters=nfilt[0][0], filter_size=new_filter_size)

    l2 = bn_conv(input_layer, num_filters=nfilt[1][0], filter_size=new_filter_size)
    l2 = bn_conv(l2, num_filters=nfilt[1][1], filter_size=5, pad=2)

    l3 = bn_conv(input_layer, num_filters=nfilt[2][0], filter_size=new_filter_size)
    ...
    l4 = bn_conv(l4, num_filters=nfilt[3][0], filter_size=new_filter_size)
...
def build_network():
    ...
    net['conv_3'] = bn_conv(net['pool'], num_filters=80, filter_size=new_filter_size)
    ...
    updates = lasagne.updates.rmsprop(loss_or_grads=train_loss, params=params,
                                      learning_rate=lr, epsilon=1.0)
...
if __name__ == "__main__":
    ...
    for e in range(num_epochs):
        ...
        filepath = '/home/rbodo/.snntoolbox/data/imagenet/' \
                   'inception_averagepool_no_bottlenecks2/{}.h5'.format(acc)
