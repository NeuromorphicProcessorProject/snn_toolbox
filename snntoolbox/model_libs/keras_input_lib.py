...
from snntoolbox.model_libs.common import AbstractModelParser
...
class ModelParser(AbstractModelParser):
    ...
    def has_weights(self, layer):
        from snntoolbox.core.util import has_weights
    ...
    def get_outbound_layers(self, layer):
        ...
        from snntoolbox.core.util import get_outbound_layers
